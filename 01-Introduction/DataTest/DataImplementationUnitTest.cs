...
namespace TP.ConcurrentProgramming.Data.Test
{
    ...
    public class DataImplementationUnitTest
    {
        ...
        [TestMethod]
        public void ballSetTest()
        {
            using (DataImplementation newInstance = new DataImplementation())
            {
                int spawnedBalls = 50;
                newInstance.Start(spawnedBalls, (startingPosition, ball) => { });
                newInstance.CheckNumberOfBalls(checkBallsAmount =>
                {
                    Assert.AreEqual(spawnedBalls, checkBallsAmount);
                });
            }
        }
    }
